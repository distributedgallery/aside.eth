...
import {Aside0x08, Aside0x08TestHelper, IAccessControl, IERC721Errors} from "../Aside0x08TestHelper.t.sol";
...
abstract contract Mint is Aside0x08TestHelper {
    ...
    //     vm.expectRevert(
    //         abi.encodeWithSelector(
    //             Aside0x08.InvalidTokenId.selector,
    //             NB_OF_TOKENS
    //         )
    //     );
    //     vm.prank(minter);
    ...
    // }
    // function test_RevertWhen_mint_WhenTokenIsAlreadyMinted()
    //     public
    //     mint
    //     unlock
    // {
